...
clockwork_orange = media.Movie("A Clockwork Orange", 
							   "In future Britain, Alex DeLarge, a charismatic and psycopath delinquent,"
							   " who likes to practice crimes and ultra-violence with his gang, is jailed"
							   " and volunteers for an experimental aversion therapy developed by the"
							   " government in an effort to solve society's crime problem"
							   " - but not all goes according to plan.",
							   "https://upload.wikimedia.org/wikipedia/en/4/48/Clockwork_orangeA.jpg", # noqa
							   "https://www.youtube.com/watch?v=vN-1Mup0UI0", # noqa
							   "18")
...
shining = media.Movie("The Shining",
				      ...
				      "https://www.youtube.com/watch?v=6lClewZeGV0", # noqa
				      "15")

misery = media.Movie("Misery",
					 "After a famous author is rescued from a car crash by a fan of his novels,"
					 " he comes to realize that the care he is receiving is only the beginning "
					 "of a nightmare of captivity and abuse.",
					 "https://upload.wikimedia.org/wikipedia/en/b/b4/Miseryposter.jpg", # noqa
					 "https://www.youtube.com/watch?v=_axcdhxe_NU", # noqa
					 "18")

film_with_me_in_it = media.Movie("A Film With Me In It",
								 "A broke, jobless actor and a broke, jobless screenwriter set"
								 " out to make a movie and then find that life starts imitating art.",
								 "https://upload.wikimedia.org/wikipedia/en/3/30/A_film_with_me_in_it.png", # noqa
								 "https://www.youtube.com/watch?v=1K-3Mu-sB6w", # noqa
								 "13A")
...
star_wars = media.Movie("Star Wars: Episode IV", 
					    ...
					    "world-destroying battle-station, while also attempting to rescue Princess Leia from"
					    " the evil Darth Vader.",
					    "https://upload.wikimedia.org/wikipedia/en/8/87/StarWarsMoviePoster1977.jpg", # noqa
					    "https://www.youtube.com/watch?v=vZ734NWnAHA", # noqa
					    "U")

meaning_of_life = media.Movie("Monty Python's The Meaning Of Life", 
							  "The comedy team takes a look at life in all its stages"
							  " in their own uniquely silly way.",
							  "https://upload.wikimedia.org/wikipedia/en/9/91/Meaningoflife.jpg", # noqa
							  "https://www.youtube.com/watch?v=mVMzc5_rdGM", # noqa
							  "12")

movies = [clockwork_orange,shining,misery,film_with_me_in_it,star_wars,meaning_of_life]
