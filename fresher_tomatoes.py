...
""" fresher_tomatoes.py
    Contains the same functionalities as the fresh_tomatoes.py file, but
    implements a way to display movies' storylines and ratings.
    If the Storyline is too short, only the first 140 characters
    will be displayed. """
